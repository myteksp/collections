...
public final class MutableTuple4<T1, T2, T3, T4> implements Tuple{
	public T1 v1;
	public T2 v2;
	public T3 v3;
	public T4 v4;
	
	public MutableTuple4(final T1 v1, final T2 v2, final T3 v3, final T4 v4) {
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
		this.v4 = v4;
	...
	public final Tuple4<T1, T2, T3, T4> toUnmutable(){
	...
	public final String toString() {
		return "MutableTuple4 [v1=" + v1 + ", v2=" + v2 + ", v3=" + v3 + ", v4=" + v4 + "]";
	}
}
